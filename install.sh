...
APP_NAME="Bluebird Focus"
APP_ID="com.bluebird.focus"
APPIMAGE="bluebird-focus_0.1.0_amd64.AppImage"
ICON="128x128.png"

BIN_DIR="$HOME/.local/bin"
ICON_DIR="$HOME/.local/share/icons/hicolor/128x128/apps"
DESKTOP_DIR="$HOME/.local/share/applications"
INSTALL_PATH="$BIN_DIR/bluebird-focus"
...
[Desktop Entry]
Name=$APP_NAME
Comment=A calm deep work companion
Exec=$INSTALL_PATH
Icon=$APP_ID
Type=Application
